...
public class FPSControllerP3_Script : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (Input.GetButton("P3GameJump") && this.anim.GetBool("isJumping") == false)
        {
        ...
        if (Input.GetButton("P3GamePickup") && this.anim.GetBool("isPickingUp") == false && this.anim.GetBool("isJumping") == false && anim.GetBool("hasItem") == false)
        {
            this.PickUpItem();
        }

        if (Input.GetButton("P3GameDropItem") && this.anim.GetBool("isPickingUp") == false)
        {
            this.DropItem();
        }

        if (Input.GetAxisRaw("P3GameThrowItem") > 0.1 && this.anim.GetBool("hasItem") == true && this.anim.GetBool("isPickingUp") == false)
        {
            this.ThrowObject();
        }
    ...
    private void ThrowObject()
    {
        ...
        if (this.itemPickedUp.GetComponentInParent<Rigidbody>() != null)
        {
            ...
            this.itemPickedUp.GetComponentInParent<objectManager>().playerNumThrown = 3;
        }
        else if (this.itemPickedUp.GetComponent<Rigidbody>() != false)
        {
            this.itemPickedUp.GetComponent<Rigidbody>().isKinematic = false;
