...
public class FPSControllerP2_Script : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        ...
        float ForwardBack = Input.GetAxis("P2GameForwardsBackwards") * this.speed;
        float strafe = Input.GetAxis("P2GameStrafeRightLeft") * this.speed;
        ...
        if (Input.GetButton("P2GameJump") && this.anim.GetBool("isJumping") == false)
        {
    ...
    private void ThrowObject()
    {
        ...
        if (this.itemPickedUp.GetComponentInParent<Rigidbody>() != null)
        {
            ...
            this.itemPickedUp.GetComponentInParent<objectManager>().playerNumThrown = 2;
